...
Strategy contracts may also call back into this contract to trigger a [hard revert](#core-spec) or [transfer tokens from the executor/bot](#transfer-tokens-from-the-executor).
